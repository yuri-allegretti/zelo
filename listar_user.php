...
<?php
            ...
            <div class='card shadow-sm' style='max-width: 480px;'>
                <div class='card-body'>
                    ...
                    <div class='d-flex gap-2'>
                        ...
                        <button onclick=\"if(confirm('Tem certeza?')){location.href='?page=salvar&acao=excluir&id=".$row->id."';}else{false}\"class='btn btn-danger'>Sair</button>
                    </div>
                </div>
            </div>";
        }
    ...
    print "
        <button onclick=\"location.href='?page=addbanco&id='\"; class='btn btn-warning' style= 'margin-top: 10px'>+ Adicionar banco!</button>
    "      
?>
